...
import net.samu.mineloween.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP = (
            ...
            .put(ModArmorMaterials.GEM, new MobEffectInstance(MobEffects.JUMP, 200, 2))
            .build();
    ...
    private boolean hasPlayerCorrectArmorOn(ArmorMaterial mapArmorMaterial, Player player) {
        ...
        return boots.getMaterial() == mapArmorMaterial && leggins.getMaterial() == mapArmorMaterial && chestplate.getMaterial() == mapArmorMaterial && helmet.getMaterial() == mapArmorMaterial;
    }

...
public class ModItems {
    ...
    public static final RegistryObject<Item> GEM_HELMET = ITEMS.register("gem_helmet", () -> new ArmorItem(ModArmorMaterials.GEM, ArmorItem.Type.HELMET, new Item.Properties()));
    public static final RegistryObject<Item> GEM_CHESTPLATE = ITEMS.register("gem_chestplate", () -> new ArmorItem(ModArmorMaterials.GEM, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> GEM_LEGGINS = ITEMS.register("gem_leggins", () -> new ArmorItem(ModArmorMaterials.GEM, ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<Item> GEM_BOOTS = ITEMS.register("gem_boots", () -> new ArmorItem(ModArmorMaterials.GEM, ArmorItem.Type.BOOTS, new Item.Properties()));

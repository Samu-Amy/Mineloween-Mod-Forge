...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        trimmedArmorItem(ModItems.GEM_HELMET);
        trimmedArmorItem(ModItems.GEM_CHESTPLATE);
        trimmedArmorItem(ModItems.GEM_LEGGINS);
        trimmedArmorItem(ModItems.GEM_BOOTS);
    }
    ...
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = SamuMineloweenMod.MOD_ID;
